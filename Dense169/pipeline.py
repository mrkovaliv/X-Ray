...
PATH_TO_MURA = "/media/andrew/b84c4d95-450e-4802-b12d-b33e25343b1b/home/andrew/MURA/"
...
def get_study_level_data(study_type):
    ...
    for phase in data_cat:
        BASE_DIR = '%s/%s/%s/' % (PATH_TO_MURA, phase, study_type)
    ...
    def __getitem__(self, idx):
        ...
        for i in range(count):
            try:
                ...
                print("FileNotFoundError, continue....")
                continue
